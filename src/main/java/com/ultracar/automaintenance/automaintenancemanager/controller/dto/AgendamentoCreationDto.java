...
public record AgendamentoCreationDto(
    @Future(message = "A data do agendamento deve ser superior à data atual") @NotNull(message = "Campo data do agendamento é obrigatório") LocalDateTime dataAgendamento,
